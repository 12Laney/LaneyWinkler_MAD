...
import UIKit
//To get the new font,I followed this tutorial:https://www.youtube.com/watch?v=mZaX9fvXbZY
...
//  var dessertTitleArray=["Gravyard Cookies", "Marshmellow Broomsticks", "Mummy Pops", "Reeses Bats", "Strawberry Ghosts"]
    ...
    var drinkIngredientsArray=[["2.5 ounces Black Vodka", "3/4 ounce Freshly Squeezed Lime Juice", "2/3 - 1 Small Lime","1/2 ounce Simple Syrup", "Ice", "Edible Pearl Dust In White"],["12 ounces Pumpkin Cider","1-2 scoops pumpkin gelato"],["2 ounces Hard Cider","1 ounce Whiskey","Ginger ale","Crushed ice"],["750 ml bottle of spiced rum","1 cup orange juice","1 cup lemon juice","1 cup spiced syrup","1/2 cup pumpkin puree","2 1/2 cups sparkling water","cinnamon sticks for garnish","dry ice for decorating"],["2 ounces 100% agave silver tequila","1 ounce lemon juice","8 blackberries","5 fresh sage leaves","1 teaspoon maple syrup","Dash of orange bitters","Dry Ice"]]
    
    var dessertIngredientsArray=[["2c. Cream cheese dip","10 crushed oreos","6 Milanos","Black decorating icing"],["12 Campfire Giant Roasters","1 10-ounce bag candy melts","assorted sprinkles"],["8 straws or lollipop sticks","11 oz. chocolate, melted","8 Nutter Butters opened","1 c. buttercream frosting","M&M's Minis, for decorating"],["10 mini Reese's cups","5 oreos","20 Candy eyes","1 tbsp. peanut butter"],["2 c. strawberries","1 1/2 c. white chocolate, melted","1 tsp. coconut oil","1/4 c. mini chocolate chips","1 c. chocolate chips, melted"]]
    ...
    func changeIngreSnack(){
        recipiIngredientes.text = "   "+"Ingredients:"+"\n"+"\n"
        if (count<0){
            count=4
        }
        if (count>4){
    ...
    func changeIngreDrink(){
        ...
        var drinkIngredients = (drinkIngredientsArray[count])
        for value in drinkIngredients{
            recipiIngredientes.text = recipiIngredientes.text!+"••" + value + "\n"
        }
        drinkIngredients.removeAll()
    }
    func changeIngreDessert(){
        recipiIngredientes.text = "   "+"Ingredients:"+"\n"+"\n"
        if (count<0){
            count=4
        }
        ...
        var dessertIngredients = (dessertIngredientsArray[count])
        for value in dessertIngredients{
            recipiIngredientes.text = recipiIngredientes.text!+"••" + value + "\n"
        }
        dessertIngredients.removeAll()
    }
